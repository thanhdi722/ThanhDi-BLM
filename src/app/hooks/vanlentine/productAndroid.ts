...
async function fetchProductAndroidValentine() {
...
export const useProductAndroidValentine = () => {
  return useQuery({
    queryKey: ["fetchProductAndroidValentine"],
    queryFn: fetchProductAndroidValentine,
    staleTime: 5000,
  });
};
