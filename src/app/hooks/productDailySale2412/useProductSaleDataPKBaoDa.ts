...
async function fetchProductSaleDataPKBaoDa() {
...
export const useProductSaleDataPKBaoDa = () => {
	return useQuery({
		queryKey: ['fetchProductSaleDataPKBaoDa'],
		queryFn: fetchProductSaleDataPKBaoDa,
		staleTime: 5000,
	});
};
