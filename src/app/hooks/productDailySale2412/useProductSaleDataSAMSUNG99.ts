...
async function fetchProductSaleDataSAMSUNG99() {
...
export const useProductSaleDataSAMSUNG99 = () => {
  return useQuery({
    queryKey: ['fetchProductSaleDataSAMSUNG99'],
    queryFn: fetchProductSaleDataSAMSUNG99,
    staleTime: 5000,
  })
}
