...
import MoneyBag from '../../../public/new-year/money-bag.gif'
import FireworkDecor from '../../../public/new-year/firework-decor-left.gif'

// Importing components
import Banner from '../../components/ComponentT3/banner-tan'
import Category from '../../components/ComponentT3/category-tan'
import ProductList from '../../components/ComponentT3/product-tan'
import ProductIpad from '../../components/ComponentT3/product-ipad-tan'
import ProductWatch from '../../components/ComponentT3/product-watch-tan'
import ProductMac from '../../components/ComponentT3/product-mac-tan'
import ProductAirPods from '../../components/ComponentT3/product-airpods-tan'
import ProductAccess from '../../components/ComponentT3/product-access-tan'
import Rules from '../../components/ComponentT3/rules'
import Snowfall from '../../components/ComponentT3/gold-fall'
...
const KhaiXuanPhuQuy = () => {
  ...
  return (
    <div className="page-new-year-month-3">
      {/* Thành phần Snowfall */}
      {/* <Snowfall /> */}
      {/* Hình ảnh túi tiền */}
