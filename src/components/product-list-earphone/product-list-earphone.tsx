...
import "./product-list-earphone.scss";
...
async function fetchProductListDataTaiNghe() {
...
const Section5: React.FC = () => {
  ...
  const { data, error, isLoading } = useQuery<Product[]>({
    queryKey: ["productListDataTaiNghe"],
    queryFn: fetchProductListDataTaiNghe,
    staleTime: 300000,
  });
  ...
  return (
    <div className="OldForNew-Section5" id="item-earphone">
