...
async function fetchProductListDataKhac() {
...
const Section5: React.FC = () => {
  ...
  const { data, error, isLoading } = useQuery<Product[]>({
    queryKey: ["productListDataKhac"],
    queryFn: fetchProductListDataKhac,
    staleTime: 300000,
  });
  ...
  return (
    <div className="OldForNew-Section5" id="item-other">
